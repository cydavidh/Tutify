...
class Chat extends React.Component {
  ...
  componentDidMount() {
    ...
    this.socket.on('start chat', ({ tutorName }) => {
      this.handleRoomChange(null, tutorName);
      // Emit 'join chat' event when a chat starts
      this.socket.emit('join chat', { tutorId: tutorName });
      // Fetch messages for the selected room
      this.socket.emit('fetch messages', { room: tutorName });
    });
  }
